...
| `install_path_selection` | 0.15 | 0.85 | Picks `aca` CLI primary; `az sandbox` ext + `adc-api.js` only when requested or for agent fan-out; Python SDK marked "coming soon". |
